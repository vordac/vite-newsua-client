...
const Footer = ({ user, auth, selectedCategory, sortingType, sortingDirection, setSelectedCategory, setSortingType, setSortingDirection }) => {
            ...
            <div className="header-row">
                ...
                <div className='links-row'>
                    ...
                    {/* <div className="index-dropdown">
                        <a className='index-dropdown-text' onClick={toggleDropdown}>ЩЕ</a>
